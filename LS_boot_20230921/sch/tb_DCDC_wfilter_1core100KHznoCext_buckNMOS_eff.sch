...
wrdata /foss/designs/Open3LFCC_V2_GD12V/data/DCDCnLDO_wfilter_1core100KHznoCext_buckNMOS_eff.txt tran.v(vh) tran.i(vh) tran.v(ldo_out) tran.i(vldo_out)
...
C {/foss/designs/Open3LFCC_V2/LS_FINAL.sym} -170 -980 0 0 {name=x2}
