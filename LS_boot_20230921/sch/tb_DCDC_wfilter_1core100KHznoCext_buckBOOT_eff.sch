...
wrdata /foss/designs/Open3LFCC_V2_GD12V/data/DCDCnLDO_wfilter_1core100KHznoCext_buckBOOT_eff.txt tran.v(vh) tran.i(vh) tran.v(ldo_out) tran.i(vldo_out) tran.v(vbat) tran.i(vbat) tran.i(vm) tran.i(vpwr)
...
device=resistor
m=1}
C {devices/lab_pin.sym} -250 -1320 2 1 {name=l39 sig_type=std_logic lab=V_gatein}
