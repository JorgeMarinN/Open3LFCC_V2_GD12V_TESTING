...
C {sky130_stdcells/inv_1.sym} -520 160 0 0 {name=x1 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
...
C {sky130_stdcells/inv_2.sym} -620 160 0 0 {name=x4 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {sky130_stdcells/inv_8.sym} -400 160 0 0 {name=x5 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
...
C {devices/vsource.sym} -700 270 0 0 {name=V4 value="PULSE(0 \{VL\} 15n 1n 1n 50n 100n)"}
C {devices/vsource.sym} -640 -250 0 0 {name=V1 value=\{VM\}}
C {devices/gnd.sym} -640 -220 0 0 {name=l16 lab=GND}
C {devices/gnd.sym} -700 300 0 0 {name=l17 lab=GND}
...
save all
tran 100n 5u
write /foss/designs/Open3LFCC_V2/LS_boot_20230921/sch/LS_BOOT.raw

plot v(trig) - v(vsource)
.endc
"}
C {sky130_fd_pr/cap_mim_m3_2.sym} -340 280 0 0 {name=C2 model=cap_mim_m3_2 W=80 L=80 MF=1 spiceprefix=X}
...
C {devices/lab_pin.sym} -460 120 0 0 {name=p10 sig_type=std_logic lab=predly}
C {devices/lab_pin.sym} -340 120 0 0 {name=p11 sig_type=std_logic lab=dly8}
C {sky130_stdcells/inv_8.sym} -450 260 0 0 {name=x8 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
...
C {devices/lab_pin.sym} 520 -250 0 0 {name=p12 sig_type=std_logic lab=vsource}
